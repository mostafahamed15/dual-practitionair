...
function SuccessReject() {
  ...
  return (
    <div className="vh-100 d-flex flex-column justify-content-center align-items-center">
      ...
      >
        <BsFillExclamationTriangleFill size={50} className=" ms-4 text-reject"  />
        <p className=" fw-bold  fs-5" style={{color:"#EB8D8D"}}>
          {translate.governmenFacility.rejectOrder.success} 
          <span className="text-reject mx-2 rounded px-2 py-1" style={{background:"#fbdfe6"}}>
      ...
      >
       <AiOutlineCheckCircle size={70} className="text-primary my-2" />
        <p className="text-secondary fw-bold mx-5">{translate.modal.cancelConfirm}</p>
        <Button
