...
return (
    <div className="d-flex flex-column align-items-center">
      ...
      <h5 className="text-secondary py-3 fw-bold">{translate.privateFacility.waitingOrder.note}</h5>
     ...
     <Button
        ...
        <Button
            variant="reject text-white rounded-pill mx-3 py-2 px-3"
        >
      ...
      <WaitingOrderModal
       ...
       question={translate.privateFacility.waitingOrderModal.accept}
       confirmMessage={translate.privateFacility.waitingOrderModal.acceptConfirm}
      />
